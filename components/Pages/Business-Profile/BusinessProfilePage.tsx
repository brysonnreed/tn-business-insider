...
import BusinessProfileMeta from 'components/Pages/Business-Profile/BusinessProfileMeta'
import { urlForImage } from 'lib/sanity/sanity.image'
import { BusinessProfile, Post, Settings } from 'lib/sanity/sanity.queries'
import Image from 'next/image'
import { notFound } from 'next/navigation'
import Carousel from 'react-multi-carousel'

import MapComponent from '../../Features/BusinessProfile/MapComponent'
import ReviewSection from '../../Features/BusinessProfile/Review/ReviewSection'
...
export default function BusinessProfilePage(props: BusinessProfilePageProps) {
  const { preview, businessProfile, settings } = props
