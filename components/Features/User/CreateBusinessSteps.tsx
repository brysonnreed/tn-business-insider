...
import AddressSection from 'components/Features/BusinessProfile/BusinessFormComponents/AddressSection'
...
export default function CreateBusiness({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
      ...
      {formStep >= 0 && (
        <section className={formStep === 0 ? 'block space-y-5' : 'hidden'}>
      ...
      {formStep >= 2 && (
        <section className={formStep === 2 ? 'block space-y-5' : 'hidden'}>
          <CategorySection
            setValue={setValue}
      ...
      {formStep >= 3 && (
        <section className={formStep === 3 ? 'block space-y-5' : 'hidden'}>
          <ImageGallerySection
            setValue={setValue}
            business={null}
